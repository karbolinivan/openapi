...
# Query params
AdditionalMetadataSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'additionalMetadata': typing.Union[AdditionalMetadataSchema, str, ],
    },
    total=False
)
...
request_query_additional_metadata = api_client.QueryParameter(
    name="additionalMetadata",
    style=api_client.ParameterStyle.FORM,
    schema=AdditionalMetadataSchema,
    explode=True,
)
# Path params
...
class BaseApi(api_client.Api):
    ...
    def _upload_file_oapg(
        ...
        for parameter in (
            request_query_additional_metadata,
        ):
