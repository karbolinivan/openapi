...
SchemaForRequestBodyApplicationXWwwFormUrlencoded = Pet
...
class BaseApi(api_client.Api):
    ...
    def _add_pet_oapg(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,SchemaForRequestBodyApplicationXml,SchemaForRequestBodyApplicationXWwwFormUrlencoded,],
        content_type: str = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
