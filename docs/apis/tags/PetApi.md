<a id="__pageTop"></a>
# openapi_client.apis.tags.pet_api.PetApi
...
------------- | ------------- | ------------- | -------------
body | typing.Union[SchemaForRequestBodyApplicationJson, SchemaForRequestBodyApplicationXml, SchemaForRequestBodyApplicationXWwwFormUrlencoded] | required |
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
additionalMetadata | AdditionalMetadataSchema | | optional
